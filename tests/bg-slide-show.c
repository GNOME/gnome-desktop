...
static void
on_bg_slideshow_loaded (GObject      *source,
                        GAsyncResult *res,
                        gpointer      user_data)
{
	...
	g_assert_true (gnome_bg_slide_show_load_finish (GNOME_BG_SLIDE_SHOW (source), res, &error));
	g_assert_no_error (error);
	*called = TRUE;
}

void
test_starttime_async (void)
{
	GTimeZone *tz;
	GDateTime *reference_time, *slide_show_time;
	GnomeBGSlideShow *slide_show;
	...
	/* Parsing XML file */
	slide_show = gnome_bg_slide_show_new ("starttime.xml");
	gnome_bg_slide_show_load_async (slide_show, NULL, on_bg_slideshow_loaded, &loaded);
...
static void
test_starttime_subprocess (GTestFunc   test_func,
                           const char *tz_str)
{
...
{
	test_starttime_subprocess (test_starttime, "C");
}

static void
test_starttime_dst (void)
{
	test_starttime_subprocess (test_starttime, "US/Eastern");
}

static void
test_starttime_no_dst_async (void)
{
	test_starttime_subprocess (test_starttime_async, "C");
}

static void
test_starttime_dst_async (void)
{
	test_starttime_subprocess (test_starttime_async, "US/Eastern");
}
      ...
      char *argv[])
{
	...
	g_test_add_func ("/bg-slide-show-async/starttime-no-dst", test_starttime_no_dst_async);
	g_test_add_func ("/bg-slide-show-async/starttime-dst", test_starttime_dst_async);
